...
export const sendVerificationEmail = async (
  ...
  try {
    await transporter.sendMail({
      ...
      to: [email],
      subject: "Verify Your Email Address for Next Notes",
      html: `<body
    style="
                              ...
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px">
                                      Thank you for signing up for Next Notes!
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px">
                                      ...
                                      did not sign up for a Next Notes account,
                                      please disregard this email.
                                    </p>
                                    <p style="margin: 0; margin-bottom: 16px">
                                      Welcome to Next Notes – the best way to
                                    ...
                                    <p style="margin: 0">The Next Notes Team</p>
                                  </div>
                                </td>
                              </tr>
                            </table>
...
export const sendPasswordResetEmail = async (
  ...
  try {
    await transporter.sendMail({
      ...
      to: [email],
      subject: "Reset Your Password for Next Notes",
      html: `<body
    style="
      background-color: #ffffff;
      margin: 0;
                              ...
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px">
                                      We received a request to reset your password for your Next Notes account. 
                                    ...
                                    <p style="margin: 0; margin-bottom: 16px">
                                      ...
                                      our support team at <a href="mailto: appnextnotes@gmail.com">
                                    </p>
                                    <p>
                                    Thank you for using Next Notes!
                                    </p>
                                    <p style="margin: 0; margin-bottom: 16px">
                                      Best regards,
                                    </p>
